...
**Luis Valde**: Implementaciòn del hook memo para poder memorizar componentes funcionales y no renderizar innecesariamente en el punto 1. (implementaciòn en carpeta 'memo')
